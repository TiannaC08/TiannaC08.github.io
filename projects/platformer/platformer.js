$(function () {
  ...
  function setup() {
    ...
    createCollectable("database", 500, 300, 20, 0.5); // creates a "database" collectible at the coordinates (500, 300), falling with a high gravity of 20, and bouncing with 50% bounce
    createCollectable("database", 500, 300); // creates a "database" collectible at the coordinates (500, 300), falling with default gravity and bouncing with default bounce %
...
createCollectable("grace", 500, 300); // creates a "grace" collectible at the coordinates (500, 300), falling with default gravity and bouncing with default bounce %
    ...
    createCannon("right", 600, 1000); // cannon on right wall, 600px down, shooting once per second
